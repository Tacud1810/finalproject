...
def notify_book_amount_change(instance, **kwargs):
    if instance.amount > 0:
        ...
        notification_users = instance.notification_users.all()
        ...
        for user in notification_users:
            ...
            instance.notification_users.remove(user)            # nemaže z notification_users
        instance.notification_users.clear()
